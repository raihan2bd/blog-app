...
RSpec.describe Post, type: :model do
  let!(:user) { User.create(name: 'Hakim', bio: 'Teacher', post_counter: 0) }
  subject do
    described_class.new(title: 'Lorem ipsum', text: 'This is my blog application.', author: user, comments_counter: 0,
                        likes_counter: 0)
  end
  ...
  describe 'associations' do
    ...
    it 'should update counter of related user' do
      expect(subject.author.post_counter).to eql 1
    end
  end
